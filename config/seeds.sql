INSERT INTO users (first_name, last_name, email, pswd)
VALUES 
("Laurie", "Aaronson", "aaronson.laurie@gmail.com", "parallelogram"),
("Matt", "Black", "matt_has_an_email@email.email", "eh"),
("Joe", "Pfahl", "joe@mac.com", "triangle"),
("Don", "Routes", "don@msn.com", "square"),
("Edwin", "Hsai", "edwin@gmail.com", "circle");
